...
void TricksterUpgradeState::initFonts()
{
...
void TricksterUpgradeState::initKeybinds()
{
...
void TricksterUpgradeState::initTextures()
{

}

void TricksterUpgradeState::initTitle()
{
	this->title.setFont(this->font);
	this->title.setCharacterSize(this->window->getSize().x / 20.f);
	this->title.setString("The Way Of Trickery");
...
void TricksterUpgradeState::initButtons()
{
...
void TricksterUpgradeState::updateInput(const float& dt)
{

}

void TricksterUpgradeState::updateButtons()
{
...
void TricksterUpgradeState::update(const float& dt)
{
...
void TricksterUpgradeState::renderButtons(sf::RenderTarget* target)
{
	for (auto& iterator : this->buttons)
	{
...
void TricksterUpgradeState::render(sf::RenderTarget* target)
{
	if (!target)
		target = this->window;
