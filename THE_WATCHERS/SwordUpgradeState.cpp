...
void SwordUpgradeState::initKeybinds()
{
...
void SwordUpgradeState::initTextures()
{
...
void SwordUpgradeState::initButtons()
{
...
void SwordUpgradeState::updateInput(const float& dt)
{

}

void SwordUpgradeState::updateButtons()
{
...
void SwordUpgradeState::update(const float& dt)
{
...
void SwordUpgradeState::renderButtons(sf::RenderTarget* target)
{
	for (auto& iterator : this->buttons)
	{
...
void SwordUpgradeState::render(sf::RenderTarget* target)
{
	if (!target)
		target = this->window;
